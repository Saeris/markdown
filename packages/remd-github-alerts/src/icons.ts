...
export const ICONS: Record<AlertType, string> = {
  // GitHub alert types — Lucide equivalents of the GitHub Octicons
  note: icon(
  ...
  important: icon('<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22z"/>'),
  warning: icon(
    '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>'
  ),
  caution: icon(
    '<circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/><path d="M12 8v4"/><path d="M12 16h.01"/>'
  ),
  ...
  danger: icon('<path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/>'),
  bug: icon(
    '<path d="m8 2 1.88 1.88"/><path d="M14.12 3.88 16 2"/><path d="M9 7.13v-1a3.003 3.003 0 1 1 6 0v1"/><path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6"/><path d="M12 20v-9"/><path d="M6.53 9C4.6 8.8 3 7.1 3 5"/><path d="M6 13H2"/><path d="M3 21c0-2.1 1.7-3.9 3.8-4"/><path d="M20.97 5c0 2.1-1.6 3.8-3.5 4"/><path d="M22 13h-4"/><path d="M17.2 17c2.1.1 3.8 1.9 3.8 4"/>'
  ),
  example: icon(
    '<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6 4 5l1 1-1 1z"/><path d="M3 12 4 11l1 1-1 1z"/><path d="M3 18 4 17l1 1-1 1z"/>'
  ),
  quote: icon(
