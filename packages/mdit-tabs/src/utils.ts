...
export const stripContinuation = (line: string): string => line.replace(CONTINUATION_RE, "");
...
// Tabs strips this before setting aria-label so attrs-consumed markers don't leak.
